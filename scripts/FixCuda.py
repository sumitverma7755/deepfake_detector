...
from config.settings import LOGS_DIR, ensure_runtime_directories
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(LOGS_DIR / 'cuda_fix.log')
    ]
)
...
def main():
    ...
    if not tf_gpu_available:
        ...
        logger.info("Run 'python scripts/run_with_gpu.py --gui' to start the application with GPU support.")
