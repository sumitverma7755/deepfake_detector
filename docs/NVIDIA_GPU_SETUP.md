...
```
python scripts/run_with_gpu.py --verify
```
...
2. **PATH Issues**:
   ...
   - Try running the `scripts/add_cuda_to_path.ps1` script as Administrator
...
```
python scripts/run_with_gpu.py --gui
```
