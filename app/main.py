...
from config.settings import (
    DEFAULT_LOG_FILE,
    MODELS_DIR as MODELS_DIR_PATH,
    OUTPUT_DIR as OUTPUT_DIR_PATH,
    ensure_runtime_directories,
)
from utils.gpu_config import configure_gpu, get_device_strategy

# Ensure runtime directories exist before any file handlers are configured.
ensure_runtime_directories()
...
from models.model_architecture import load_model_from_checkpoint
    ...
    def _load_models(self):
        ...
        try:
            ...
            if not os.path.exists(self.model_dir):
                ...
                logger.info("Please run scripts/download_models.py to download pre-trained models.")
                return
